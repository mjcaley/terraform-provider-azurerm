...
func resourceArmWebSourceControl() *schema.Resource {
	return &schema.Resource{
		Create: resourceArmWebSourceControlCreateUpdate,
		Read:   resourceArmWebSourceControlRead,
		Update: resourceArmWebSourceControlCreateUpdate,
		Exists: resourceArmWebSourceControlExists,
		Delete: resourceArmWebSourceControlDelete,
...
func resourceArmWebSourceControlCreateUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	return resourceArmWebSourceControlRead(d, meta)
}

func resourceArmWebSourceControlRead(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ArmClient).resourceGroupsClient
	ctx := meta.(*ArmClient).StopContext
...
func resourceArmWebSourceControlExists(d *schema.ResourceData, meta interface{}) (bool, error) {
	client := meta.(*ArmClient).resourceGroupsClient
	ctx := meta.(*ArmClient).StopContext
...
func resourceArmWebSourceControlDelete(d *schema.ResourceData, meta interface{}) error {
	client := meta.(*ArmClient).resourceGroupsClient
	ctx := meta.(*ArmClient).StopContext
